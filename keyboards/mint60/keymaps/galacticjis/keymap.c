...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    MO(2),    KC_GRV,    KC_LALT,    MT_EISU,    KC_SPC,        KC_SPC, MT_KANA,  KC_BSPC,               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,    KC_DEL, \
    RGB_TOG,   RGBRST,  RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX,   XXXXXXX, XXXXXXX, RGUI(JP_LCBR), RGUI(JP_RCBR), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    ...
    XXXXXXX,   _______,    _______,    _______,    XXXXXXX,       KC_BSPC, XXXXXXX, XXXXXXX,                   KC_HOME, KC_PGDN, KC_END \
  ),
  [2] = LAYOUT( \
    XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,     XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, \
    XXXXXXX,   XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, JP_AT, XXXXXXX, XXXXXXX, \
