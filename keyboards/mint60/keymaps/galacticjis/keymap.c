...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    MO(2),    XXXXXXX,    KC_LALT,    MT_EISU,    KC_SPC,        KC_SPC, MT_KANA,  JP_AT,               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
  ...
  [2] = LAYOUT( \
    ...
    RGB_TOG,   RGBRST,  RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX,   XXXXXXX,  KC_7,      KC_8,      KC_9,      KC_0, XXXXXXX, XXXXXXX, XXXXXXX, \
    XXXXXXX,     RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX,   XXXXXXX,  KC_4,     KC_5,      KC_6,      XXXXXXX, XXXXXXX,        XXXXXXX, \
